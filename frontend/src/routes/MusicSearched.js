...
import BackGroundImage from '../imgs/BackGroundMusic.jpg';
...
const MusicSearched = () => {
    ...
    return (
        <div className="h-screen min-h-full w-screen min-w-full overflow-x-hidden bg-contain bg-center" style={{ backgroundImage: `url(${BackGroundImage})` }}>
            <NavBar />
