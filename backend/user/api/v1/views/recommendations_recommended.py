...
def get_all_recommended_books():
    ...
    """
    try:
        book_recommendations = storage.all_with(
                                                Recommendation,
                                                **{"item_type": "book"}
                                                )
...
def get_all_recommended_music():
    ...
    """
    try:
        music_recommendations = storage.all_with(
                                                 Recommendation,
                                                 **{"item_type": "music"})
...
def get_all_recommended_movies():
    ...
    """
    try:
        movie_recommendations = storage.all_with(
                                                 Recommendation,
                                                 **{"item_type": "movie"})
...
@app_views.route('/book/recommended/delete',
                 methods=['DELETE'])
@login_required
