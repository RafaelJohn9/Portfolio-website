...
class TestFetchMovies(unittest.TestCase):
    ...
    def test_fetch_movies_success(self, mock_get):
        ...
        expected_movie_details = [{'title': 'Inception', 'release_date': '2010-07-16', 'overview': 'A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O.', 'rating': 8.3, 'poster': 'https://image.tmdb.org/t/p/w500/9gk7adHYeDvHkCSEqAvQNLV5Uge.jpg'}]
        self.assertEqual(movie_details, expected_movie_details)
